...
do
    ...
    do
        ...
        echo "  output: '$lavQueryDir/$queryChr/{A}.lav'" >> $snakeDir/$queryChr.snake
        echo "  shell: 'lastz {input.targetNib} {input.queryNib} $lastzPara > {output}'" >> $snakeDir/$queryChr.snake
        echo "rule psl:" >> $snakeDir/$queryChr.snake
        echo "  input: lavs='$lavQueryDir/$queryChr/{A}.lav'" >> $snakeDir/$queryChr.snake
        echo "  output: psls='$pslQueryDir/$queryChr/{A}.psl'" >> $snakeDir/$queryChr.snake
        echo "  shell: 'lavToPsl {input.lavs} {output.psls}'" >> $snakeDir/$queryChr.snake
        echo "rule chain:" >> $snakeDir/$queryChr.snake
        echo "  input: psls='$pslQueryDir/$queryChr/{A}.psl'" >> $snakeDir/$queryChr.snake
        echo "  output: chains='$chainQueryDir/$queryChr/{A}.chain'" >> $snakeDir/$queryChr.snake
